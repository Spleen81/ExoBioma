# The Exobioma Project
### From Biochemical Atmospheric Models to Validating Signatures of Exoplanetary Life

![Project Status](https://img.shields.io/badge/Status-Vision%20%26%20Roadmap-blueviolet) ![Discipline](https://img.shields.io/badge/Focus-Astrobiology%20%2F%20Computational%20Ecology-005b96) ![Timeline](https://img.shields.io/badge/Timeline-2025--2030-success)

## 🌌 Abstract: The Paradigm Shift
The search for life in the universe has traditionally focused on "habitability"—a binary state largely defined by the presence of liquid water and equilibrium temperatures ($T_{eq}$). **The Exobioma Project** aims to transcend this definition. 
...
1.  **Beyond The Goldilocks Zone:** Can we quantify the "biological capacity" of an atmosphere using strictly measured extremophilic tolerances rather than Earth-centric assumptions?
2.  **The Ecological Imprint:** How does a microbial biosphere modify the chemical complexity of an atmosphere over geological timescales?
3.  **Observational Reality:** Can we link high-complexity indices in atmospheric networks to specific volatile organic compounds (VOCs) detectable by **JWST** and **ARIEL**?

---

## 🗺️ The Roadmap (2025-2030)

The Exobioma Project is structured into five distinct developmental phases.

### Phase 1: Beyond Habitability (Current Status: *In Publication*)
...
### Phase 2: Alien Biochemistries (2025-2026)
* **Goal:** Building `MLS 2.0`.
* **Focus:** Expanding the database beyond terrestrial analogs. Integrating theoretical biochemistries and metabolic pathways suitable for non-standard environments (e.g., high-pressure ice, hydrocarbon lakes).

### Phase 3: Modeling ExoBiomes (2026-2027)
...
### Phase 4: Decoding Life (2027-2028)
...
### Phase 5: The Smoking Gun (2029-2030)
...
* `/Data`: Future home for the Unified Extremophile Database and CRN topology datasets.
* `/Docs`: White papers, theoretical frameworks, and supplementary material for publications.
* `/Models`: Long-term storage for atmospheric impact simulation outputs.
...
**Principal Investigator:** Marco Marcellino marco.marcellino@inaf.it
...
---
*© 2025 Exobioma Project. All rights reserved.*
